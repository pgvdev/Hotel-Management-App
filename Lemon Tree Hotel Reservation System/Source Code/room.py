...
class Room:
    def __init__(self, master):
        ...
        self.master.geometry("548x570+0+260")
        ...
        # TITLE BANNER
        title_banner_image = Image.open("/Users/pop/Downloads/topbannerROOM.png")
        title_banner_image = title_banner_image.resize((548, 50), Image.Resampling.LANCZOS)
        ...
        label_img.place(x=0, y=0, width=548, height=50)
        ...
        labelframe_ls.place(x=5, y=50, width=538, height=173)
        ...
        button_frame.place(x=350, y=0, width=173, height=148)


        # ADD RESERVATION
        add_room_button = Button(button_frame, text="Add", command=self.insert_data, font=("arial", 12, "bold"), bg="black",
                                 fg="gold", width=19)
        add_room_button.grid(row=0, column=0, padx=1, pady=1)


        # UPDATE RESERVATION
        update_room_button = Button(button_frame, text="Update", command=self.update_data, font=("arial", 12, "bold"), bg="black",
                                    fg="gold", width=19)
        update_room_button.grid(row=1, column=0, padx=1, pady=10)


        # RESET RESERVATION
        reset_room_button = Button(button_frame, text="Reset", command=self.reset_data, font=("arial", 12, "bold"), bg="black",
                                   fg="gold", width=19)
        reset_room_button.grid(row=2, column=0, padx=1, pady=10)


        # DELETE RESERVATION
        delete_room_button = Button(button_frame, text="Delete", command=self.delete_data, font=("arial", 12, "bold"), bg="black",
                                    fg="gold", width=19)
        delete_room_button.grid(row=3, column=0, padx=1, pady=1)


        ######### MySQL TABLE FRAME #########
        # Frame for displaying room details in a table
        mysql_table_frame = LabelFrame(self.master, bd=0, relief=RIDGE, text="", font=("arial", 12, "bold"),bg="#d84c42", padx=2)
        mysql_table_frame.place (x=3, y=230, width=542, height=330)
