...
class Reservations:
    def __init__(self, master):
        ...
        # TITLE BANNER
        title_banner_image = Image.open("/Users/pop/Downloads/topbannerRESERVATION.png")
        ...
        labelframe_ls = LabelFrame(self.master, bd = 0, relief = RIDGE, text = "",
        ...
        # Fetch Data Button
        fetchData_button = Button(labelframe_ls, command=self.fetch_customer_search, text="Search", font=("arial", 11, "bold"), bg="#d84c42",
                                  fg="#d84c42", width=4)
        fetchData_button.place(x=290, y=1)
        ...
        # Booking ID Input
        booking_id_input = ttk.Entry(labelframe_ls, textvariable=self.var_bookingID, width=29, state="readonly" ,font=("arial", 13, "bold"))
        ...
        combobox_payment_method = ttk.Combobox(labelframe_ls, textvariable=self.var_payment_method, font=("arial", 13, "bold"), width=26, state="readonly")
        ...
        bill_payment_button = Button(labelframe_ls, text="Check Out",bg="#d84c42", command=self.total, font=("arial", 13, "bold"),
                                     fg="#d84c42", width=13, height=2)
        bill_payment_button.place(x=210, y=450)

        ######### BUTTON FRAME #########
        button_frame = Frame(labelframe_ls, bd=0, bg="#d84c42",relief=RIDGE)
        button_frame.place(x=0, y=447, width=205, height=55)


        # ADD RESERVATION
        add_reservation_button = Button(button_frame, text="Add", command=self.insert_data, font=("arial", 11, "bold"), bg="#d84c42",
                                        fg="#d84c42", width=9)
        add_reservation_button.grid(row=0, column=0, padx=1, pady=1)


        # UPDATE RESERVATION
        update_reservation_button = Button(button_frame, text="Update", command=self.update_data, font=("arial", 11, "bold"), bg="#d84c42",
                                           fg="#d84c42", width=9)
        update_reservation_button.grid(row=0, column=1, padx=1, pady=1)


        # RESET RESERVATION
        reset_reservation_button = Button(button_frame, text="Reset", command=self.reset_data, font=("arial", 11, "bold"), bg="#d84c42",
                                          fg="#d84c42", width=9)
        reset_reservation_button.grid(row=1, column=0, padx=1, pady=1)


        # DELETE RESERVATION
        delete_reservation_button = Button(button_frame, text="Delete", command=self.delete_data, font=("arial", 11, "bold"), bg="#d84c42",
                                           fg="#d84c42", width=9)
        delete_reservation_button.grid(row=1, column=1, padx=1, pady=1)


        # Right side IMAGE
        img3 = Image.open("/Users/pop/Downloads/rightsidebanner.png")
        img3 = img3.resize((550, 225), Image.Resampling.LANCZOS)
        ...
        ######### MySQL TABLE FRAME #########
        mysql_table_frame = LabelFrame(self.master, bd=1, relief=RIDGE, text="Booking Search System", font=("arial", 12, "bold"), bg="#d84c42",padx=2)
    ...
    def fetch_customer_search(self):
        if self.search_customer_input.get() == "":
            ...
            try:
                ...
                display_data_frame.place(x=380, y=57, width=260, height=227)
